...
export default function EnergyImportsOverTime({ iso3, title, subtitle, description, source, note, useMillions = false }) {
  const [allData, setAllData] = useState(null);

  useEffect(() => {
    loadFile('assets/data/cdde_energy_imports.json')
      .then(r => r?.json())
  ...
  return (
    <div className="cdde_card">
      ...
      <LineChartTime series={series} lineColor="var(--un-color-purple)" ariaLabel="Line chart of energy imports over time" tooltipUnit={useMillions ? 'mn USD' : 'bn USD'} />
